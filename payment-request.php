...
if (isset($_POST['submit'])) {
    ...
    $purchase_order_date = $_POST['inputPurchasedOrderDate'];
    ...
    // Validate the data
    if (empty($amount) || empty($purchase_order_id) || empty($purchase_order_name) || empty($name) || empty($email) || empty($phone) || empty($address) || empty($purchase_order_date)) {
    ...
    // Store data in session for use in payment-response.php
    ...
    $postFields = array(
        "return_url" => "http://localhost/PROJECTEVENT/projectevent/payment-response.php/",
        "website_url" => "http://localhost/PROJECTEVENT/projectevent/",
        "amount" => $amount,
        "purchase_order_id" => $purchase_order_id,
        "purchase_order_name" => $purchase_order_name,
        "customer_info" => array(
